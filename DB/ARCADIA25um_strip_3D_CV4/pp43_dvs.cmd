...
;;  Creation date: 08/2/2019
;;  Last modified: 08/2/2019
;;--------------------------------------------------------------------
...
(define DSi 25) ;Silicon Depth
(define pwW 7)	; pwell Width
(define pwD 7)	; pwell Depth
(define dpwW 7) ; deep pwell Width
(define dpwD 7) ; deep pwell Depth
(define nwW 2.5)	; nwell Width
(define nwD 2.5)	; nwell Depth
...
(sdegeo:imprint-rectangular-wire (position  (+ nwSTART 0.5) 0 0) (position  (- nwSTOP 0.5) 0 WSi))
(sdegeo:imprint-rectangular-wire (position  0 0 0) (position  5 0 DSi))
(sdegeo:imprint-rectangular-wire (position  (- WSi 5) 0 0) (position  WSi 0 DSi))
...
;;(sdegeo:define-3d-contact (find-face-id (position 5 0 2.5)) "Ptop")
(sdegeo:define-3d-contact (find-face-id (position (- WSi 2.5) 0 10)) "Ptop")
;;(sdegeo:define-3d-contact (find-face-id (position 5 0 (- DSi 2.5))) "Ptop")
...
(sdedr:define-refeval-window "WinNtop"   "Rectangle"  (position nwSTART 0 0) (position nwSTOP 0 DSi)) 	      ;line to start Ntop doping
...
;global mesh options
(sdedr:define-refinement-size "RefDefGlobal" 20 5 20 2 2 2 )
...
(sdedr:define-refinement-size "RefDefSurf" 2 2 2 0.5 0.5 0.5 )
...
(sdedr:define-refinement-size "RefDefBot" 4 1 4 2 0.5 2 )
...
;saving and meshing 
(sde:save-model "p43")
(sde:build-mesh "snmesh" "-a -c boxmethod" "n43")
