...
Placements {
	...
	AnalyticalProfile "PlacPbot" {
		Reference = "ProfPbot"
		ReferenceElement {
			Element = Polygon [ (0 100 0) (0 100 100) (100 100 100) (100 100 0)]
		}
	}
	...
	Refinement "RefPlacGlobal" {
		...
		RefineWindow = Cuboid [(-1 -1 -1) (101 101 101)]
	}
	...
	Refinement "RefPlacBot" {
		Reference = "RefDefBot"
		RefineWindow = Cuboid [(0 98 0) (100 100 100)]
	}
	Refinement "RefPlacPart" {
		Reference = "RefDefPart"
		RefineWindow = Cuboid [(-2 0 -2) (2 100 2)]
	}
}
