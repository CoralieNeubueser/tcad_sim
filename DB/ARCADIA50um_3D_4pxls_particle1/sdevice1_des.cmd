...
Electrode {
	{ Name="Ntop_0_0" Voltage=@vn@}
	{ Name="Ntop_0_1" Voltage=@vn@}
	{ Name="Ntop_1_0" Voltage=@vn@}
	{ Name="Ntop_1_1" Voltage=@vn@}
	{ Name="Ptop" Voltage=0 }
...
File 	{
	Grid  = "@tdr@"
     	lifetime = "@tdr@"
     	param   = "@parameter@"
     	current = "@tsi@_@xpart@_@zpart@_@vbot@_@let@.plt"  
     	plot    = "@tsi@_@xpart@_@zpart@_@vbot@_@let@.tdr"  
}
...
Solve {
	...
	MinStep=1e-15
	Increment=1.5
	# Plot { Range = (0 2e-8) Intervals =10}
	)
