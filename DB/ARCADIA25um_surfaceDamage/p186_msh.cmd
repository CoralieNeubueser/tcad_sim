...
Definitions {
	...
	Refinement "RefDefSurf" {
		MaxElementSize = ( 0.2 0.2 0 )
		MinElementSize = ( 0.025 0.025 0 )
		RefineFunction = MaxTransDiff(Variable = "DopingConcentration",Value = 1)
	}
...
Placements {
	...
	Refinement "RefPlacSurf" {
		...
		RefineWindow = Rectangle [(0 -0.2) (25 10)]
	}
