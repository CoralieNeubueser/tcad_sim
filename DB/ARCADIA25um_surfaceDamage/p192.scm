...
(sdedr:define-refeval-window "WinPtop1" "Line" (position 0 0 0) (position 10.75 0 0))
(sdedr:define-refeval-window "WinPtop2" "Line" (position 14.25 0 0) (position 25 0 0))
(sdedr:define-refeval-window "WinDPtop1" "Line" (position 0 0 0) (position 8 0 0))
...
(sdedr:define-refeval-window "RefWinSurf" "Rectangle" (position 0 -0.2 0) (position 25 10 0))
