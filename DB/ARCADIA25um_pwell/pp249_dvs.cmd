...
(define pwW (- (/ (- WSi nwW) 2) 0.5))	; pwell Width
(define dpwW 10) ; deep pwell Width
...
; surface mesh
(sdedr:define-refeval-window "RefWinSurf" "Rectangle"  (position 0 0 0) (position WSi 10 0)) 	
(sdedr:define-refinement-size "RefDefSurf" 0.3 0.3 0 0.05 0.05 0 )
...
;saving and meshing 
(sde:save-model "p249")
(sde:build-mesh "snmesh" "-a -c boxmethod" "n249")
