...
(sdedr:define-refeval-window "WinPtop1" "Line" (position 0 0 0) (position 10.25 0 0))
(sdedr:define-refeval-window "WinPtop2" "Line" (position 14.75 0 0) (position 25 0 0))
(sdedr:define-refeval-window "WinDPtop1" "Line" (position 0 0 0) (position 10 0 0))
(sdedr:define-refeval-window "WinDPtop2" "Line" (position 15 0 0) (position 25 0 0))
