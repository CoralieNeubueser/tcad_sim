...
File 	{
	Grid  = "@tdr@"
     	lifetime = "@tdr@"
     	param   = "@parameter@"
     	current = "@gap@_@dpwell_width@.plt"  
     	plot    = "@gap@_@dpwell_width@.tdr"  
}
...
File {
	Output = "@log@"
	ACExtract = "ac_@gap@_@dpwell_width@"
}
...
Solve {
	...
	Quasistationary(
		...
		Goal { Parameter=vnt.dc Voltage=@vn@ }
	) { Coupled { Poisson Electron Hole} }
	...
	newcurrentprefix = "cv_"
   	...
   	Quasistationary (
		...
		Goal { Parameter=vpb.dc Voltage=@vbot@ }
	) { ACCoupled (
