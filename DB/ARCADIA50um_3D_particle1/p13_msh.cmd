...
Placements {
	...
	AnalyticalProfile "PlacDPwell1" {
		...
		ReferenceElement {
			Element = Polygon [ (0 0 0) (0 0 50) (16 0 50) (16 0 0)]
		}
	}
	AnalyticalProfile "PlacDPwell2" {
		Reference = "ProfDPwell"
		ReferenceElement {
			Element = Polygon [ (34 0 0) (34 0 50) (50 0 50) (50 0 0)]
		}
	}
	AnalyticalProfile "PlacDPwell3" {
		Reference = "ProfDPwell"
		ReferenceElement {
			Element = Polygon [ (16 0 0) (16 0 16) (34 0 16) (34 0 0)]
		}
	}
	AnalyticalProfile "PlacDPwell4" {
		Reference = "ProfDPwell"
		ReferenceElement {
			Element = Polygon [ (16 0 34) (16 0 50) (34 0 50) (34 0 34)]
		}
	}
	...
	AnalyticalProfile "PlacPbot" {
		Reference = "ProfPbot"
		ReferenceElement {
			Element = Polygon [ (0 100 0) (0 100 50) (50 100 50) (50 100 0)]
		}
	}
	Refinement "RefPlacGlobal" {
		Reference = "RefDefGlobal"
		RefineWindow = Cuboid [(-1 -1 -1) (51 101 51)]
	}
	...
	Refinement "RefPlacBot" {
		Reference = "RefDefBot"
		RefineWindow = Cuboid [(0 98 0) (50 100 50)]
	}
	Refinement "RefPlacPart" {
		Reference = "RefDefPart"
		RefineWindow = Cuboid [(23 0 23) (27 100 27)]
	}
}
