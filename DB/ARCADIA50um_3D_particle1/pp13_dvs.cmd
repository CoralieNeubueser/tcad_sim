...
(define TSi 100)	; Silicon thickness
...
; particle
(sdedr:define-refeval-window "RefWinPart" "Cuboid"  (position (- 25 2) 0 (- 25 2)) (position (+ 25 2) TSi (+ 25 2))) 	
...
;saving and meshing 
(sde:save-model "p13")
(sde:build-mesh "snmesh" "-a -c boxmethod" "n13")
